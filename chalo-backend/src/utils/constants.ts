...
export const CONSTANTS = {
  ...
  DRIVER_SEARCH_RADIUS_KM_EXPANDED: 12, // Punjab expansion: 12km after first pass exhausted
  ...
  DRIVER_SEARCH_MAX_CANDIDATES: 10,      // Max drivers to consider per pass
  ...
  MIN_RATING: 1,
  MAX_RATING: 5,
  NEW_DRIVER_RATING_THRESHOLD: 10,   // Drivers with fewer ratings than this show "New" and use neutral score
  NEW_DRIVER_NEUTRAL_RATING: 3.5,    // Neutral rating used in matching for new drivers (instead of 0)
  ...
  SERIAL_CANCEL_COOLDOWN_MINS: 15,        // Cooldown duration after too many cancellations
  SERIAL_CANCEL_THRESHOLD_HOURLY: 3,      // Cancellations within 1 hour before cooldown kicks in
  SERIAL_CANCEL_WARNING_COUNT: 5,         // Lifetime count at which warning is shown in response
  ...
  DEFAULT_CANCEL_FEE: 20,               // ₹20 if customer cancels after free window (time-based)
  DEFAULT_CANCEL_FEE_ARRIVED: 40,       // ₹40 if customer cancels after driver has arrived at pickup

  // Reason codes that waive the fee (driver is at fault)
  DRIVER_FAULT_REASON_CODES: ['DRIVER_ASKED_TO_CANCEL', 'DRIVER_NOT_MOVING', 'DRIVER_WRONG_VEHICLE', 'DRIVER_BEHAVIOUR'] as const,
  // This specific reason also increments the driver's cancellation count (driver gamed the system)
  DRIVER_FORCED_CANCEL_CODE: 'DRIVER_ASKED_TO_CANCEL' as const,
  ...
  CONFIG_KEYS: {
    ...
    ENABLE_DYNAMIC_SURGE: 'enable_dynamic_surge',
    ENABLE_WALLET: 'enable_wallet',
    ENABLE_PLACES_AUTOCOMPLETE: 'enable_places_autocomplete',
    ...
    CANCEL_FEE_ARRIVED_AMOUNT: 'cancel_fee_arrived_amount',
    GST_PERCENTAGE: 'gst_percentage',
    DRIVER_SEARCH_RADIUS_KM_EXPANDED: 'driver_search_radius_km_expanded',
  },
} as const;
